...
class _StreamingResponse implements LlmState {
  const _StreamingResponse({required this.response});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$StreamingResponseCopyWith<_StreamingResponse> get copyWith =>
      __$StreamingResponseCopyWithImpl<_StreamingResponse>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _StreamingResponse &&
            (identical(other.response, response) ||
                other.response == response));
  }
  ...
  @override
  String toString() {
    return 'LlmState.streaming(response: $response)';
  }
}

/// @nodoc
abstract mixin class _$StreamingResponseCopyWith<$Res>
    implements $LlmStateCopyWith<$Res> {
  factory _$StreamingResponseCopyWith(
          _StreamingResponse value, $Res Function(_StreamingResponse) _then) =
      __$StreamingResponseCopyWithImpl;
  @useResult
  $Res call({LlmResponse response});
...
/// @nodoc
class __$StreamingResponseCopyWithImpl<$Res>
    implements _$StreamingResponseCopyWith<$Res> {
  __$StreamingResponseCopyWithImpl(this._self, this._then);

  final _StreamingResponse _self;
  final $Res Function(_StreamingResponse) _then;
  ...
  $Res call({
    ...
    return _then(_StreamingResponse(
...
class _LoadedResponse implements LlmState {
  const _LoadedResponse({required this.response});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LoadedResponseCopyWith<_LoadedResponse> get copyWith =>
      __$LoadedResponseCopyWithImpl<_LoadedResponse>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LoadedResponse &&
            (identical(other.response, response) ||
                other.response == response));
  }
  ...
  @override
  String toString() {
    return 'LlmState.loaded(response: $response)';
  }
}

/// @nodoc
abstract mixin class _$LoadedResponseCopyWith<$Res>
    implements $LlmStateCopyWith<$Res> {
  factory _$LoadedResponseCopyWith(
          _LoadedResponse value, $Res Function(_LoadedResponse) _then) =
      __$LoadedResponseCopyWithImpl;
  @useResult
  $Res call({LlmResponse response});
...
/// @nodoc
class __$LoadedResponseCopyWithImpl<$Res>
    implements _$LoadedResponseCopyWith<$Res> {
  __$LoadedResponseCopyWithImpl(this._self, this._then);

  final _LoadedResponse _self;
  final $Res Function(_LoadedResponse) _then;
