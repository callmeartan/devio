...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String content, DateTime timestamp, bool isUserMessage});
}
...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, content: $content, timestamp: $timestamp, isUserMessage: $isUserMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, timestamp, isUserMessage);
...
abstract class _Message implements Message {
  const factory _Message(
      ...
      required final bool isUserMessage}) = _$MessageImpl;
